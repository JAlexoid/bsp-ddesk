 ...
 * @version $Revision: 169646 $ $Date: 2005-05-11 11:34:57 -0400 (Wed, 11 May 2005) $
 */
class _MessageUtils {
    ...
    static FacesMessage getMessage(FacesContext facesContext, Locale locale,
	...
	try {
	    ...
	    return ResourceBundle.getBundle(bundleName, locale, facesContext
